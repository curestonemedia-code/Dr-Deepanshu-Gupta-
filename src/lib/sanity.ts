// Same Sanity project as thecurestone.com — one Studio (in the sanity-cms
// repo), one shared taxonomy (categories, tags, authors). Blog posts are
// told apart by their `siteId` field (see lib/blogs.ts), not by a separate
// project or dataset.
